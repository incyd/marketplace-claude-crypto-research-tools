> **ARCHIVE COPY (v3.0)** — This file is kept for historical reference only.
> The PRIMARY runtime version is `agents/agent-weekly-learning.md`.
> Do NOT edit this file for v3.1 changes — edit the `agents/` version instead.
...
| 2 | _(this file)_ `config/agent_weekly_learning.md` | **Full file** — you're already here | ESSENTIAL |
